...
* [x] Added floating action button to compose new tweets
* [x] Added animation when liking a tweet
* [x] Added floating action button to compose new tweets
* [x] Highlight urls, user mentions, and hashtags
* [x] Display twitter icon in the toolbar
* [x] Added share button to share a link to a tweet
* [x] Better formatting on the relative timestamp on timeline tweets
* [x] Added floating action button to compose new tweets
* [x] Display extra badge next to verified users names
* [x] Added transition animation when opening tweet detail view
* [x] Added extra indicators on tweets that are retweets or replies
* [x] Get full tweet text without truncation
